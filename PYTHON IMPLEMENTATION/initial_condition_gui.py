...
def inital_condition_GUI():
    ...
    entries["Size"].set(0)
    entries["Size"].grid(row = 1, column = 2, padx=10, pady=5)
    ...
    entries["I_Energy"].grid(row = 2, column = 2, padx=10, pady=5)
    ...
    entries["I_Age"].set(0)
    entries["I_Age"].grid(row = 3, column = 2, padx=10, pady=5)
    ...
    dropdown1.grid(row = 4, column = 2,padx=10, pady=5)

    # WORLD SETTING
    label6 = Label(root, text = "WORLD SETTINGS")
    label6.grid(row = 5, column = 1, padx=10, pady=5)

    # DENSITY
    label7 = Label(root, text = "Active cell % : ")
    label7.grid(row = 6, column = 0, padx=10, pady=5)
    entries["Active"] = (Scale(root, from_=0, to=100, orient="horizontal"))
    entries["Active"].set(0)
    entries["Active"].grid(row = 6, column = 2, padx=10, pady=5)
    ...
    entries["C_Min"].set(0)
    entries["C_Min"].grid(row = 7, column = 2, padx=10, pady=5)

    # MAX ENERGY
    label9 = Label(root, text = "Maximum energy : ")
    label9.grid(row = 8, column = 0, padx=10, pady=5)
    entries["C_Max"] = (Scale(root, from_=0, to=1000, orient="horizontal"))
    entries["C_Max"].set(0)
    entries["C_Max"].grid(row = 8, column = 2, padx=10, pady=5)

    # CELL DISTRIBUTION
    label10 = Label(root, text = "Initial distribution : ")
    label10.grid(row = 9, column = 0, padx=10, pady=5)
    ...
    dropdown2.grid(row = 9, column = 2,padx=10, pady=5)

    # PARAMETERS SETTINGS
    label11 = Label(root, text = "PARAMETERS SETTINGS")
    label11.grid(row = 10, column = 1, padx=10, pady=5)

    # PARAMETERS DISTRIBUTION
    label12 = Label(root, text = "Initial distribution : ")
    label12.grid(row = 11, column = 0, padx=10, pady=5)
